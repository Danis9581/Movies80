...
export function MovieModal({ movie, onClose }) {
  ...
  useEffect(() => {
    ...
    const fetchSpanishOverview = async () => {
      try {
        ...
        setSpanishOverview(null); // Si falla, usará la versión en inglés
      }
    };
  ...
  return (
    ...
    >
      ...
      <div 
        className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl max-w-4xl w-full p-6 relative border-2 border-red-900/50 shadow-2xl overflow-hidden"
      ...
      >
        ...
        <button 
          ...
          className="
            ...
            text-3xl font-mono
            leading-none /* Crítico */
            p-1 /* Espacio mínimo para hover */
            cursor-pointer
          "
          aria-label="Cerrar"
        >
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="relative group w-full md:w-1/3">
            ...
            <div className="absolute bottom-2 left-2 text-red-400 font-mono text-xs tracking-wider">
          ...
          <div className="flex-1">
            ...
            <h2 className="text-4xl font-bold text-red-500 mb-3 font-sans tracking-tight drop-shadow-[0_0_8px_rgba(220,38,38,0.7)]">
              {movie.title}
            </h2>
            
            {/* Metadatos */}
            <div className="flex flex-wrap gap-3 items-center mb-5">
              <span className="bg-gradient-to-r from-yellow-600 to-yellow-400 text-black px-3 py-1 rounded-full text-sm font-bold flex items-center">
              ...
              <span className="text-gray-300 font-mono text-sm bg-gray-800/50 px-3 py-1 rounded-full border border-gray-700">
                {movie.release_date}
              </span>
            ...
            {/* Descripción */}
            <div className="mb-6">
              <h3 className="text-red-400 font-mono tracking-wider text-sm mb-2">SINOPSIS DEL ARCHIVO:</h3>
              <p className="text-gray-300 text-lg leading-relaxed border-l-2 border-red-900/50 pl-4 italic">
            ...
            <div className="grid grid-cols-2 gap-5">
              <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-800">
                <h3 className="text-red-400 font-mono tracking-wider text-sm mb-2">GÉNEROS</h3>
              ...
              <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-800">
                <h3 className="text-red-400 font-mono tracking-wider text-sm mb-2">ESTADO</h3>
                <p className="text-gray-300 font-serif">
